...
import ru.seleznev.otus_java_2017_10.homework2.calculator.MemoryCalculatorUtil;
...
import static ru.seleznev.otus_java_2017_10.homework2.calculator.MemoryCalculatorUtil.containerSize;

public class MainConsoleTalkingInterface {
    ...
    private static void run(final String className) {
        for (final Class clazz : getClass(className)) {
            ...
            logger.info("Class '{}' takes {} bytes", clazz.getCanonicalName(), MemoryCalculatorUtil.sizeEmpirically(clazz));
            logger.info("");
